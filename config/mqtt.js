...
module.exports = {
  ...
  |
  */
  host: Env.get('MQTT_HOST', 'soldier.cloudmqtt.com'),
  ...
  */
  ...
  |
  */
  username: Env.get('MQTT_USERNAME', 'lhgijooh'),
  ...
  |
  */
  password: Env.get('MQTT_PASSWORD', 'TjILo2B3B6kL'),
